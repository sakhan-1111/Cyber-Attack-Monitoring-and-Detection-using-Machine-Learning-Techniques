...
# Create pipeline
pipe_DT = make_pipeline(DecisionTreeClassifier(random_state=42))
...
gs_pca = GridSearchCV(estimator=pipe_DT, param_grid=param_grid, scoring='accuracy', cv=10, n_jobs=-1)
