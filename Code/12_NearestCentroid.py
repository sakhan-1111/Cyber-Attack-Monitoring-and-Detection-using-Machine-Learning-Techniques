...
# Create pipeline
pipe_NC_pca = make_pipeline(StandardScaler(), PCA(n_components=2), NearestCentroid())

# GridSearch & Cross-validation
# Setting parameters
param_grid = [{'nearestcentroid__metric': ['minkowski', 'cityblock', 'cosine', 'euclidean', 'haversine', 'l1', 'l2', 'manhattan', 'nan_euclidean']}]

# Set up grid search & cross validation for pca
gs_pca = GridSearchCV(estimator=pipe_NC_pca, param_grid=param_grid, scoring='accuracy', cv=10, n_jobs=-1)
